                        ...
                        <div className="p-6 sm:px-8">
                            ...
                            <ul className="mt-2 space-y-2 sm:mt-4">
                                ...
                                <li className="flex items-center gap-1">
                                    ...
                                    <span className="text-gray-700"> Hébergement en ligne du CV </span>
                                </li>
                                ...
                                <li className="flex items-center gap-1">
                                    ...
                                    <span className="text-gray-700"> Accès limité aux offres d&apos;emploi </span>
                                </li>
                        ...
                        <div className="p-6 sm:px-8">
                            ...
                            <ul className="mt-2 space-y-2 sm:mt-4">
                                ...
                                <li className="flex items-center gap-1 ">
                                    ...
                                    <span className="text-gray-700 text-sm"> Suivi des vues sur son profil </span>
                                </li>
                                ...
                                <li className="flex items-center gap-1 ">
                                    ...
                                    <span className="text-gray-700 text-sm"> Export en PDF optimisé </span>
                                </li>
                        ...
                        <div className="p-6 sm:px-8">
                            ...
                            <ul className="mt-2 space-y-2 sm:mt-4">
                                <li className="flex items-center gap-1">
                                    ...
                                    <span className="text-gray-700"> Gestion et suivi des candidatures </span>
                                </li>
